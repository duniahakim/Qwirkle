from Qwirkle import GameBoard, Piece, SHAPES, COLORS
...
class QwirkleGame:
    ...
    def main(self, players):
        ...
        for player in players:
            if player == 'agent1':
                self._players.append(Agent1('Player %i' % player_number))
            elif player == 'agent2':
                self._players.append(Agent2('Player %i' % player_number))
            elif player == 'agent3':
                self._players.append(Agent3('Player %i' % player_number))
            elif player == 'human':
        ...
        while True:
            ...
            score = self._players[current_player].play_turn(self._board)
